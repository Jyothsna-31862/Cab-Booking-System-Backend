...
public class RatingControllerTests {
    ...
    @Test
    @DisplayName("POST /api/ratings should handle RuntimeException and return 500")
    void createRating_shouldReturnInternalServerError_whenRuntimeException() throws Exception {
        when(ratingService.createRating(any(RatingDTO.class)))
                .thenThrow(new RuntimeException("An error occurred while saving the rating."));
